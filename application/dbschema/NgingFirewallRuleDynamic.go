...
type Slice_NgingFirewallRuleDynamic = factory.Slicex[*NgingFirewallRuleDynamic]
...
func (a *NgingFirewallRuleDynamic) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingFirewallRuleDynamic) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		...
		case *[]*NgingFirewallRuleDynamic:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFirewallRuleDynamic(*v))
		case []*NgingFirewallRuleDynamic:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFirewallRuleDynamic(v))
		case factory.Ranger:
...
func (a *NgingFirewallRuleDynamic) Clone() *NgingFirewallRuleDynamic {
	cloned := NgingFirewallRuleDynamic{Id: a.Id, Name: a.Name, SourceType: a.SourceType, SourceArgs: a.SourceArgs, Regexp: a.Regexp, ActionType: a.ActionType, ActionArg: a.ActionArg, AggregateDuration: a.AggregateDuration, AggregateRegexp: a.AggregateRegexp, OccurrenceNum: a.OccurrenceNum, OccurrenceDuration: a.OccurrenceDuration, Disabled: a.Disabled, Created: a.Created, Updated: a.Updated}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingFirewallRuleDynamic) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingFirewallRuleDynamic) TrimOverflowText(column string, value string) string {
